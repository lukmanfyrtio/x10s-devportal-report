...
public class DashboardControllerv2 {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(DashboardControllerv2.class);

	@Autowired
	private DashboardService dashboardService;

	@GetMapping("/percentage-report")
	public ResponseEntity<?> getApiUsagePercentageV1(Authentication authentication
	...
	public ResponseEntity<?> getQuotaReportV1() {
	...
	public ResponseEntity<?> getDashboardApiUsageByDateV1(
	...
	public ResponseEntity<?> getDashboardApiFaultByDateV1(
	...
	public ResponseEntity<?> getDashboardApiFaultDetailsV1(
			Authentication authentication, @RequestParam("filter") String filter,
	...
	public ResponseEntity<?> getDashboardTotalReportV1(
			Authentication authentication) {
